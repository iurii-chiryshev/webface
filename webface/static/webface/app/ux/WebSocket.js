/**
 * @see https://github.com/wilk/ExtJS-WebSocket
 * Только я его чутка переименовал с Ext.ux.. на Webface.ux.. Соответственно, лежит он теперь в моем приложении.
 * Причина в том, что это неофициальный пакет Ext и мне не удалось заставить sencha cmd правильно его собрать
 * вместе с приложением
 */
Ext.define ('Webface.ux.WebSocket', {
